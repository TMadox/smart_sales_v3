                  ...
                  child: Center(
                    child: Text(
                      ValuesManager.doubleToString(
                              widget.generalState.currentReceipt['oper_value'])
                          .toString(),
                    ...
                    child: TextFormField(
                      ...
                      onTap: () {
                        discountController.selection = TextSelection(
                            baseOffset: 0,
                            extentOffset: discountController.value.text.length);
                      },
                      onChanged: (value) {
                        log(value);
                        final currentValue = widget
                            .generalState.currentReceipt["oper_disc_value"];
                        try {
                          if (value != "" && value != ".") {
                            widget.generalState.changeReceiptValue(input: {
                            ...
                            widget.generalState.changeReceiptValue(
                                input: {"oper_disc_value": double.parse("0")});
                          }
                        } catch (e) {
                  ...
                  child: Center(
                    child: TextFormField(
                      ...
                      onChanged: (value) {
                        log(value);
                        final currentValue = widget
                            .generalState.currentReceipt["oper_add_value"];
                        try {
                          if (value != "" && value != ".") {
                            widget.generalState.changeReceiptValue(
                                input: {"oper_add_value": double.parse(value)});
                          } else {
