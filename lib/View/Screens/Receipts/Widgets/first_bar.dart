            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: AutoSizeText(
                      receiptsController.selectedEntity?.name ?? "unknown".tr,
                      maxLines: 1,
                      ...
                      onTap: () {
                        ...
                        if (receiptsController
                          ...
                          Get.to(
                            () => ClientsScreen(
                              canPushReplace: true,
                              sectionType: receiptsController.currentReceipt
                  ...
                  AutoSizeText.rich(
                    TextSpan(
                      children: [
                        ...
                        TextSpan(
                          text: ": " + CurrentDate.getCurrentDate().toString(),
                          style: GoogleFonts.cairo(
                            color: Colors.white,
                          ),
                        )
                  ...
                  AutoSizeText.rich(
                    TextSpan(
                      children: [
                        ...
                        TextSpan(
                          text: ": " + CurrentDate.getCurrentTime().toString(),
                        ...
                        return Directionality(
                          ...
                          child: FloatingActionButton(
                            backgroundColor: (receiptsController
                                        .currentReceipt.value["force_cash"] ??
                                    false)
                                ? Colors.grey
                            ...
                            onPressed: (receiptsController
                                ...
                                : () {
                                    ...
                                    if (receiptsController.currentReceipt
                                            .value["pay_by_cash_only"] ==
                                        1) {
                                      receiptsController.changeReceiptValue(
                                        input: {
                                          "pay_by_cash_only": 0,
                                          "cash_value": 0.0,
                                        },
